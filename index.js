const STORE = [
  {
   ...
   answerImg: '<img class="answerimg" src="./manatee1.jpeg" alt="Manatee floating in a lagoon" width="500" >'
 },
 {
   ...
   answerImg: '<img class="answerimg" src="./baby-manatee.jpg" "A baby manatee being exaimed gently by a carer" width="500">'
 },
 {
   question: 'How old do manatees live to be in the <strong>wild</strong>?',
   answers: [
     '10 - 20 years old',
     '20 - 30 years old',
     '30 - 40 years old',
   ...
   answerImg: '<img src="./snooty.jpg" alt="Snooty the manatee facing the camera" width="500">'
 },
 {
   ...
   answerImg: '<img src="./couple-manatee.jpg" alt="Two manatees eating together underwater" width="500">'
 },
 {
   ...
   answerImg: '<img src="./owie-manatee.jpg" alt="Manatee with scars on back from boats" width="500">'
 },
 {
   ...
   answerImg: '<img src="./manatee-elephant.jpg" alt="Manatee and Elephant side by side comparison" width="500">'
 },
 {
   ...
   answerImg: '<img src="./manate-species.png" alt="The three manatee species" width="700">'
 },
 {
   ...
   answerImg: '<img src="./manatee-eating.jpg" alt="Manatee eating sea grass" width="500">'
 },
 {
   ...
   answerImg: '<img src="./manatee-day.jpg" alt="Manatee Appreciation Day" width="500">'
 },
 {
   ...
   answerImg: '<img src="./manatee-boop.gif" alt="Manatee boops the aquarium glass" width="500">'
  }
];
...
function generateQuestion () {
  if (questionNumber < STORE.length) {
    ...
    <span><img class="manateeIcon" src="./manatee-icon.jpg" alt="Cartoon Manatee Icon" width="50">${STORE[questionNumber].answers[0]}</span>
    </label>
    <label class="answerOption">
    <input type="radio" value="${STORE[questionNumber].answers[1]}" name="answer" required>
    <span><img class="manateeIcon" src="./manatee-icon.jpg" alt="Cartoon Manatee Icon" width="50">${STORE[questionNumber].answers[1]}</span>
    </label>
    <label class="answerOption">
    <input type="radio" value="${STORE[questionNumber].answers[2]}" name="answer" required>
    <span><img class="manateeIcon" alt="Cartoon Manatee Icon" src="./manatee-icon.jpg" width="50">${STORE[questionNumber].answers[2]}</span>
    </label>
    <label class="answerOption">
    <input type="radio" value="${STORE[questionNumber].answers[3]}" name="answer" required>
    <span><img class="manateeIcon" alt="Cartoon Manatee Icon" src="./manatee-icon.jpg" width="50">${STORE[questionNumber].answers[3]}</span>
    </label>
...
function userAnswer() {
  if (STORE[questionNumber].correctAnswer === true) {
...
function userAnswerWrong () {
  $('.quizForm').html(`<div class="correctFeedback"><h2>You got it wrong</h2><img src="./huge-manatee.jpg" width="600"><br><p>${STORE[questionNumber].comment}</span></p><button type=button class="nextButton">Next</button></div>`);
};
